                            ...
                            <div class="bg-primary bg-soft">
                                <div class="row">
                                    ...
                                    <div class="col-12 align-self-end">
                                        <img src="{{url('/')}}/admin/assets/images/profile-img.png" alt="profile-img" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <a href="index.html">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="{{url('/')}}/admin/assets/images/logo.svg" alt="logo" class="rounded-circle" height="34">
                                            </span>
                                        </div>
                                    </a>
                                </div>
