            ...
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10" id="image_hide">
                        ...
                        <img src="{{url('/images/testimonials/'.$testimonial->image)}}" alt="{{isset($testimonial)?$testimonial->name:''}}" style="height: 100px;"> <i class="bx bx-window-close text-danger" onClick="hideimage()"></i>
                    </div>
                    @endif
