                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{url('/images/portfolios/'.$value['image'])}}" target="_blank">View Image</a></td>
                                ...
                                <td>
                                    <a href="{{route('portfolios.edit',$value->id)}}"><i class="bx bx-pencil"></i> Edit </a> | <a href="javascript:void(0);" onclick="portfolios({{$value->id}})" class="text-danger"><i class="bx bx-trash-alt"></i> Delete</a>
                                </td>
...
<script>
    function portfolios(tid){
        if(confirm('Are You sure'))
        {
        $.ajax({
            method:'DELETE',
            url: '{{ url('admin/portfolios/') }}/'+tid,
            data:{
                id: tid,
                _token: '{{ csrf_token() }}'
            },
