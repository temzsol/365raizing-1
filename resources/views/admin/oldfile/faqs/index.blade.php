                            ...
                            <tr>
                                ...
                                <td>{{$value['answer']}}</td>
                                   <td><div class="form-check form-switch form-switch-md mb-3" dir="ltr">
                                    ...
                                    <label class="form-check-label" for="SwitchCheckSizemd{{$value->id}}">@if($value->fetured==1){{'Show'}}@else {{'Not Show'}} @endif</label>
                                    </div>
                                </td>
                                <td><div class="form-check form-switch form-switch-md mb-3" dir="ltr">
                                ...
                                <td>
                                    <a href="{{route('faqs.edit',$value->id)}}"><i class="bx bx-pencil"></i> Edit </a> | <a href="javascript:void(0);"  onClick="deletepages('{{$value->id}}')" class="text-danger"><i class="bx bx-trash-alt"></i> Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
