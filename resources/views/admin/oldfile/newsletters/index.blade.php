                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{url('/images/newsletters/'.$value['html_file'])}}" target="_blank">View File</a></td>
                                ...
                                <td>
                                    <a href="{{route('newsletters.edit',$value->id)}}"><i class="bx bx-pencil"></i> Edit </a> | <span>
