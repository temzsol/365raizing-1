                            ...
                            <tr>
                                ...
                                <td><div class="form-check form-switch form-switch-md mb-3" dir="ltr">
                                    ...
                                    <label class="form-check-label" for="SwitchCheckSizemd{{$value->id}}">@if($value->status==1)
                                        <button class="btn btn-success">Completed</button> <button class="btn btn-danger">@if(isset($employeeTask) && $employeeTask->status=='0') To Do @endif</button>
                                        <button class="btn btn-success">Completed</button> <button class="btn btn-warning">@if(isset($employeeTask) && $employeeTask->status=='2') In Progress @endif</button>
                                        <button class="btn btn-success">Completed</button> <button class="btn btn-success">@if(isset($employeeTask) && $employeeTask->status=='1')Completed @endif</button>
                                         @endif</label>
                                    </div>
                                </td>
